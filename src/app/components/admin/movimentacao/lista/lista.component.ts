...
export class ListaComponent implements OnInit {
  ...
  @Input() movimentacoes!: Movimentacao[] | null | undefined;
  @Input() requisicaoSelecionada!: Requisicao| null | undefined;
  @Input() displayDialogMovimentacoes!: boolean| null | undefined;
  @Input() funcionarioLogado!: Funcionario| null | undefined;
